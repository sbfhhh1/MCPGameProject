...
for n,c in cols.items():
 ...
 mel.set_material_instance_scalar_parameter_value(mi,"Edge Transmission",0.6)
 mel.set_material_instance_scalar_parameter_value(mi,"Edge Transmission Power",2.5)
 mel.update_material_instance(mi)
 unreal.EditorAssetLibrary.save_loaded_asset(mi)
 unreal.log("[Br2] "+n+" brightened")