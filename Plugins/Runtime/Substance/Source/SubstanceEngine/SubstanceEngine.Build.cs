...
public class SubstanceEngine : ModuleRules
{
	...
	**/
	...
	public SubstanceEngine(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		StaticLibs.Add("substance_linker_full");
		...
		if (Target.IsInPlatformGroup(UnrealPlatformGroup.Windows))
		{
			...
			EngineLibs.Add(SubstanceEngineType.CPU, "substance_sse2_blend_s");
			EngineLibs.Add(SubstanceEngineType.GPU, "substance_d3d11_blend_s");
		}
		else if (Target.Platform == UnrealTargetPlatform.Mac)
		{
			...
			EngineLibs.Add(SubstanceEngineType.CPU, "substance_cpu_blend_s");
			EngineLibs.Add(SubstanceEngineType.GPU, "substance_ogl3_blend_s");
		}
        else if (Target.Platform == UnrealTargetPlatform.Linux)
		{
			...
			EngineLibs.Add(SubstanceEngineType.CPU, "substance_sse2_blend_s");
			EngineLibs.Add(SubstanceEngineType.GPU, "substance_vk_blend_s");
		}
		else
		{
		...
		if (Target.Type == TargetRules.TargetType.Editor)
		{
			...
			StaticLibs.Add("substance_framework_full_editor");
		...
		else
		{
			...
			StaticLibs.Add("substance_framework_full");
