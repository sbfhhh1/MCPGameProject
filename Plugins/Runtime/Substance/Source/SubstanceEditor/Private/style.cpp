...
{
TSharedPtr<FSlateStyleSet> FSubstanceConnectorStyle::m_style_set = nullptr;

void FSubstanceConnectorStyle::Initialize()
{
	// Only register once
...
void FSubstanceConnectorStyle::Shutdown()
{
	if (m_style_set.IsValid())
	{
#if WITH_EDITOR
...
FName FSubstanceConnectorStyle::GetStyleSetName()
{
	static FName SubstanceStyleName(TEXT("SubstanceLinkStyle"));
	return SubstanceStyleName;
}

TSharedPtr<class ISlateStyle> FSubstanceConnectorStyle::Get()
{
	return m_style_set;
}
