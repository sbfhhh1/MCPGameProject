...
class SUBSTANCECORE_API USubstanceSettings : public UObject
{
	...
	UPROPERTY(EditAnywhere, Config, Category = "Substance Import Settings", meta = (DisplayName = "Default Substance Material Template", AllowedClasses = "/Script/Engine.Material,/Script/Engine.MaterialInstance,/Script/Engine.MaterialInterface"))
