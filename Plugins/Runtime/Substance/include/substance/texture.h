...
#include "platformdep.h"
	...
	/** @brief Substance engine texture (results) structure
		...
		@note Only 'image' and 'format' members are used for texture input. Other members are discarded. */
	typedef struct SubstanceTexture_
	{
		/** @brief Vulkan image,
		...
		/** @brief Vulkan format of the texture (VkFormat)
		           MUST be filled for texture inputs */
		int format;
	...
	/** @brief Substance engine texture (results) structure
		...
		@warning Texture OUTPUT must be deleted by substanceContextTextureRelease()
		@note Only 'texture' and 'format' members are used for texture input. Other members are discarded. */
	typedef struct SubstanceTexture_
	{
		/** @brief Metal texture,
		    If used as INPUT: must be ready for pixel read, pixel read ready
